...
package org.smartregister.opensrp.ui.questionnaire
...
import org.smartregister.opensrp.robolectric.ActivityRobolectricTest
import org.smartregister.opensrp.ui.questionnaire.QuestionnaireActivity.Companion.QUESTIONNAIRE_ARG_BARCODE
import org.smartregister.opensrp.ui.questionnaire.QuestionnaireActivity.Companion.QUESTIONNAIRE_FRAGMENT_TAG
...
class QuestionnaireActivityTest : ActivityRobolectricTest() {
  ...
  fun testQuestionnaireSubmitButtonDisplayCorrectTitle() {
    with(questionnaireActivity) {
      ...
      updateViews()
      val button = findViewById<Button>(org.smartregister.opensrp.R.id.submit_questionnaire)
      if (button != null) {
