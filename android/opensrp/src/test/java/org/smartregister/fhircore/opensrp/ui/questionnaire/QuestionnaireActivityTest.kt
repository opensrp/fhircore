...
package org.smartregister.fhircore.opensrp.ui.questionnaire
...
import org.smartregister.fhircore.opensrp.coroutine.CoroutineTestRule
import org.smartregister.fhircore.opensrp.robolectric.ActivityRobolectricTest
import org.smartregister.fhircore.opensrp.ui.questionnaire.QuestionnaireActivity.Companion.QUESTIONNAIRE_ARG_BARCODE
import org.smartregister.fhircore.opensrp.ui.questionnaire.QuestionnaireActivity.Companion.QUESTIONNAIRE_FRAGMENT_TAG
...
class QuestionnaireActivityTest : ActivityRobolectricTest() {
  ...
  fun testQuestionnaireSubmitButtonDisplayCorrectTitle() {
    with(questionnaireActivity) {
      ...
      updateViews()
      val button =
        findViewById<Button>(org.smartregister.fhircore.opensrp.R.id.submit_questionnaire)
      if (button != null) {
