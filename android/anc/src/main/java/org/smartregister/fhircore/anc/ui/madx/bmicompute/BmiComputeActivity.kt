...
class BmiComputeActivity : QuestionnaireActivity() {
    ...
    override fun handleQuestionnaireResponse(questionnaireResponse: QuestionnaireResponse) {
        lifecycleScope.launch {
            ...
            val inputHeight =
                bmiComputeViewModel.getInputHeight(questionnaireResponse, isUnitModeMetric)
            val inputWeight =
                bmiComputeViewModel.getInputWeight(questionnaireResponse, isUnitModeMetric)
            val computedBMI =
                bmiComputeViewModel.calculateBMI(inputHeight, inputWeight, isUnitModeMetric)
    ...
    private fun proceedRecordBMI(
        ...
        lifecycleScope.launch {
            val success = bmiComputeViewModel.saveComputedBMI(
                questionnaire!!,
