...
class FamilyDetailScreenKtTest : RobolectricTest() {
    ...
    fun testMembersList() {
        ...
        composeRule.setContent { MembersList(familyMembers,  { listenerObjectSpy.onAddMemberItemClick() }) { listenerObjectSpy.onMemberItemClick(familyMember) } }
    ...
    fun testEncounterList() {
        ...
        composeRule.setContent { EncounterList(encounters) { listenerObjectSpy.onEncounterItemClick(item) } }
