...
internal class RemoveFamilyQuestionnaireActivityTest : ActivityRobolectricTest() {
  ...
  private lateinit var removeFamilyQuestionnaireActivity:
    org.smartregister.fhircore.quest.ui.family.removefamily.RemoveFamilyQuestionnaireActivity
  ...
  private fun buildActivityFor(form: String, editForm: Boolean, headId: String? = null) {
    ...
    removeFamilyQuestionnaireActivity =
      Robolectric.buildActivity(
          org.smartregister.fhircore.quest.ui.family.removefamily
              .RemoveFamilyQuestionnaireActivity::class
            .java,
          intent
        )
        .create()
