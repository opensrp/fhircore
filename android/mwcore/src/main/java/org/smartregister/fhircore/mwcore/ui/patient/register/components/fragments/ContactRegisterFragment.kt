...
import org.smartregister.fhircore.mwcore.ui.patient.register.components.lists.ContactRegisterList

class ContactRegisterFragment : ComposeRegisterFragment<Patient, PatientItem>() {
    ...
    companion object {
        const val TAG = "ContactRegisterFragment"
    }
}