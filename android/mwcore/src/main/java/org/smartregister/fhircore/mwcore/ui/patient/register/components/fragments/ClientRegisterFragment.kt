...
import org.smartregister.fhircore.mwcore.ui.patient.register.components.lists.ClientRegisterList

class ClientRegisterFragment : ComposeRegisterFragment<Patient, PatientItem>() {
    ...
    companion object {
        const val TAG = "ClientRegisterFragment"
    }
}