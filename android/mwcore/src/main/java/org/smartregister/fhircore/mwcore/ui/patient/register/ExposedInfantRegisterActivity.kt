...
class ExposedInfantRegisterActivity: BaseRegisterActivity() {
    private val exposedInfantsRegister = "mwcore-app-exposed-infants-register"
    private lateinit var registerViewConfiguration: RegisterViewConfiguration

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        registerViewConfiguration = loadRegisterViewConfiguration(exposedInfantsRegister)
        configureViews(registerViewConfiguration)
    }

    override fun supportedFragments(): Map<String, Fragment> =
        mapOf(Pair(ExposedInfantRegisterFragment.TAG, ExposedInfantRegisterFragment()))

    override fun mainFragmentTag() = ExposedInfantRegisterFragment.TAG
