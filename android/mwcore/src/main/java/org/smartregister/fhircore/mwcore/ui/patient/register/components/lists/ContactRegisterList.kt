...
import org.smartregister.fhircore.mwcore.ui.patient.register.components.list_items.ContactListItem

@Composable
fun ContactRegisterList(
    ...
    LazyColumn {
        items(pagingItems, key = { it.id }) {
            ContactListItem(it!!, clickListener, modifier = modifier)
