...
fun DateSelectionBox(
    ...
    Column(
        ...
        Text(
            ...
            modifier = modifier
                .wrapContentWidth()
                .testTag(DATE_RANGE_TITLE_TEST_TAG)
        )
        ...
        Row(
            ...
            Text(
                ...
                modifier = modifier
                    ...
                    .testTag(DATE_RANGE_SEPARATOR_TEST_TAG)
            )
...
fun setCustomReflection(dpd: MaterialDatePicker.Builder<Pair<Long, Long>>): MaterialDatePicker.Builder<Pair<Long, Long>> {
    try {
