...
constructor(
    ...
    private suspend fun fetchToken(
        ...
        if (tokenAuthenticator.sessionActive() && practitionerDetails != null) {
            ...
            if (existingCredentials != null && !username.equals(
    ...
    fun savePractitionerDetails(
        ...
        viewModelScope.launch {
            bundle.entry.forEach { entry ->
                ...
                val practitioners =
                    practitionerDetails.fhirPractitionerDetails?.practitioners ?: listOf()
                val practitionerId =
                ...
                practitionerDetails.fhirPractitionerDetails?.practitionerRoles?.toTypedArray()
                    ?.let {
                        defaultRepository.createRemote(false, *it)
                    }
                practitionerDetails.fhirPractitionerDetails?.organizationAffiliations?.toTypedArray()
                    ?.let {
                        defaultRepository.createRemote(false, *it)
                    }
