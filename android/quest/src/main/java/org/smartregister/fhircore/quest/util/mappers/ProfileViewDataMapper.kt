    ...
    return when (inputModel) {
      is ProfileData.AncProfileData ->
        ProfileViewData.PatientProfileViewData(
          ...
          sex = Enumerations.AdministrativeGender.FEMALE.translateGender(context),
          ...
          familyMemberViewStates =
            inputModel.members.map { memberProfileData ->
              FamilyMemberViewState(
                patientId = memberProfileData.logicalId,
                birthDate = memberProfileData.birthdate,
                age = memberProfileData.birthdate.toAgeDisplay(),
      ...
      else -> ProfileViewData.PatientProfileViewData()
    }
  }
