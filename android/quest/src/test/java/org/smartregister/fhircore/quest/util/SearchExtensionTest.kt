...
class SearchExtensionTest {
  ...
  @Test
  fun testFilterByPractitionerShouldAddStringFilter() {
    val search = Search(ResourceType.Practitioner)
    search.filterByPractitioner(ReferenceClientParam("link"), "123344")
    ...
    assertEquals("Practitioner/123344", referenceFilters[0].value)
