...
class PdfLauncherFragmentTest : RobolectricTest() {
  ...
  @BindValue
  val pdfLauncherViewModel: PdfLauncherViewModel = mockk(relaxed = true)
  ...
  fun testPdfGeneration() = runBlocking {
    ...
    coEvery { pdfLauncherViewModel.retrieveQuestionnaireResponse(any(), any(), any()) } returns questionnaireResponse
    ...
    val fragment = PdfLauncherFragment().apply {
