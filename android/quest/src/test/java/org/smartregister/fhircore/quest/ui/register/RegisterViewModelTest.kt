...
class RegisterViewModelTest : RobolectricTest() {
  ...
  // TODO Test more scenarios (e.g. filter by quantity, refs etc) during Code Health Thursdays
  @Test
  fun testUpdateRegisterFilterStateShouldUpdate() {
