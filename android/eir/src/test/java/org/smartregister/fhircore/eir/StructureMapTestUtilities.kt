...
class StructureMapTestUtilities : RobolectricTest() {
  ...
  @Test
  fun `perform extraction from pnc visit questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/pnc_visit/questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/pnc_visit/pnc_routine_visit.map".readFile()
    ...
    val scu = org.hl7.fhir.r4.utils.StructureMapUtilities(contextR4, transformSupportServices)
    val map = scu.parse(patientRegistrationStructureMap, "PNC Visit Registration")
  ...
  @Test
  fun `perform extraction from pnc outcome registration questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/pnc_outcome/questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/pnc_outcome/pregnancy_outcome_registration.map".readFile()
    ...
    val scu = org.hl7.fhir.r4.utils.StructureMapUtilities(contextR4, transformSupportServices)
    val map = scu.parse(patientRegistrationStructureMap, "PNC Registration")
  ...
  @Test
  fun `perform extraction from new fp registration questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/fp_registration/questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/fp_registration/new_fp_registration.map".readFile()
    ...
    val scu = org.hl7.fhir.r4.utils.StructureMapUtilities(contextR4, transformSupportServices)
    val map = scu.parse(patientRegistrationStructureMap, "FP Registration")
  ...
  @Test
  fun `perform extraction from under 2 months and under 5 years sick child questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/child/under_2_months_sick_child_questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/child/under_2_months_sick_child_registration.map".readFile()
    ...
    val scu = org.hl7.fhir.r4.utils.StructureMapUtilities(contextR4, transformSupportServices)
    val map = scu.parse(patientRegistrationStructureMap, "under_2_months_sick_child_registration.map")
  ...
  @Test
  fun `perform extraction from over 2 months and under 5 years sick child questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/child/over_2_months_sick_child_questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/child/sick_child_registration.map".readFile()
    ...
    val scu = org.hl7.fhir.r4.utils.StructureMapUtilities(contextR4, transformSupportServices)
    val map = scu.parse(patientRegistrationStructureMap, "sick_child_registration.map")
  ...
  @Test
  fun `perform extraction from under 1 child visit questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/child/under1_child_questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/child/under1_child_visit.map".readFile()
  ...
  @Test
  fun `perform extraction from over 1 child visit questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/child/over1_child_questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/child/over1_child_visit.map".readFile()
  ...
  @Test
  fun `perform extraction from new anc registration questionnaire response`() {
    val patientRegistrationQuestionnaireResponse =
      "structure-map-questionnaires/quest/ecbis-saa/anc/new_anc_registration_questionnaire_response.json".readFile()
    val patientRegistrationStructureMap =
      "structure-map-questionnaires/quest/ecbis-saa/anc/new_pregnancy_registration.map".readFile()
    ...
    val scu = org.hl7.fhir.r4.utils.StructureMapUtilities(contextR4, transformSupportServices)
    val map = scu.parse(patientRegistrationStructureMap, "Pregnancy Registration")
  ...
  fun generateStructureMap() {
    ...
    val scu = org.hl7.fhir.r4.utils.StructureMapUtilities(contextR4, transformSupportServices)
    val map = scu.parse(patientRegistrationStructureMap, "eCBIS Disease Registration")
