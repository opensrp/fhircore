...
package org.smartregister.fhircore.eir.structuremap
...
class StructureMapTestUtilities : RobolectricTest() {
  ...
  fun performExtraction() {
    ...
    val map = scu.parse(fhirStructureMapForAdverseEvents, "AdverseReaction")
...
group ExtractRelatedPerson(source src : QuestionnaireResponse, target bundle : Bundle, source patientId : Patient) {
  ...
  private val questionnaireResponseForAdverseEvent = """ 
    {"resourceType":"QuestionnaireResponse","item":[{"linkId":"adverse-event-reaction","item":[{"linkId":"adverse-event-codes","answer":[{"valueCoding":{"system":"https://www.snomed.org","code":"75753009","display":"Blood clots"}}]},{"linkId":"adverse-event-date","answer":[{"valueDate":"2021-09-03"}]}]}]}
  """.trimIndent()
