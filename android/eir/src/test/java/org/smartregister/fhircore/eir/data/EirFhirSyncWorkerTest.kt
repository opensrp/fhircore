...
class EirFhirSyncWorkerTest : RobolectricTest() {
  ...
  private lateinit var periodicFhirSyncWorker: EirFhirSyncWorker
  ...
  fun setUp() {
    ...
    periodicFhirSyncWorker = EirFhirSyncWorker(EirApplication.getContext(), workerParam)
  }

  @Test
  fun testGetFhirEngineShouldReturnNonNullFhirEngine() {
    Assert.assertNotNull(periodicFhirSyncWorker.getFhirEngine())
  }

  @Test
  fun testGetSyncDataReturnMapOfConfiguredSyncItems() {
    val data = periodicFhirSyncWorker.getSyncData()
  ...
  fun testGetDataSourceReturnsDataSource() {
    Assert.assertNotNull(periodicFhirSyncWorker.getDataSource())
  }
}
