...
class OAuthInterceptorTest : RobolectricTest() {
  ...
  @Before
  fun setUp() {
    val creds = AuthCredentials("demo", CharArray(1), "dummy_token")
    SecureSharedPreference(EirApplication.getContext()).saveCredentials(creds)
    interceptor = OAuthInterceptor(EirApplication.getContext())
  }
