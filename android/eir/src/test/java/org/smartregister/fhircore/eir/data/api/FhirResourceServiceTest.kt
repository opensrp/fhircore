...
package org.smartregister.fhircore.eir.data.api
...
class FhirResourceServiceTest : RobolectricTest() {
  ...
  fun `create() should return HapiFhirService with correct base url, client, interceptors and converter factories`() {
    ...
    val hapiFhirService =
      FhirResourceService.create(parser, ApplicationProvider.getApplicationContext())
  ...
  private fun FhirResourceService.getRetrofitInstance(): Retrofit {
