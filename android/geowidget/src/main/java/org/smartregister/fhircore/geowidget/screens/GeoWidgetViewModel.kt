...
class GeoWidgetViewModel @Inject constructor(val dispatcherProvider: DispatcherProvider) :
  ...
  fun getServicePointKeyToType(): Map<String, ServicePointType> {
    ...
    map[ServicePointType.ECOLE_COMMUNAUTAIRE.name.lowercase()] = ServicePointType.ECOLE_COMMUNAUTAIRE
    ...
    map[ServicePointType.CHU.name.lowercase()] = ServicePointType.CHU
    return map
  }
}
