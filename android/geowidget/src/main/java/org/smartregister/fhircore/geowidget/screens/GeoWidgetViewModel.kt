...
class GeoWidgetViewModel : ViewModel() {
  ...
  fun getServicePointKeyToType(): Map<String, ServicePointType> {
    ...
    map[ServicePointType.CENTRE_DE_TRAITEMENT_DU_CHOLERA.name.lowercase()] = ServicePointType.CENTRE_DE_TRAITEMENT_DU_CHOLERA
    ...
    map[ServicePointType.BUREAU_DES_PARTENAIRES.name.lowercase()] = ServicePointType.BUREAU_DES_PARTENAIRES
    map[ServicePointType.LYCÉE.name.lowercase()] = ServicePointType.LYCÉE
    map[ServicePointType.DIRECTION_COMMUNALE_DE_L_ENSEIGNEMENT.name.lowercase()] = ServicePointType.DIRECTION_COMMUNALE_DE_L_ENSEIGNEMENT
