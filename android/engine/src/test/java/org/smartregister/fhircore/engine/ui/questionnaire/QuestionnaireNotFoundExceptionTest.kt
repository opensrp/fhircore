...
class QuestionnaireNotFoundExceptionTest {

  @Test
  fun `constructor with formName and cause`() {
    val testFormName = "test_form"
    val testCause = NotImplementedError()
    val questionnaireNotFoundException =
