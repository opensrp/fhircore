...
@HiltAndroidTest
class LoginActivityHasActivePinTrueTest : ActivityRobolectricTest() {
  ...
  @Test
  fun testNavigateToPinLoginShouldVerifyExpectedIntent() {
    val loginConfig = loginViewConfigurationOf(enablePin = true)
    loginViewModel.updateViewConfigurations(loginConfig)
    loginViewModel.navigateToHome()
    val expectedIntent = Intent(getActivity(), PinLoginActivity::class.java)
