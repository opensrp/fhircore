...
class DeviceToDeviceSyncConfigTest() {
  ...
  @Test
  fun testTestEquals() {
    var sameDeviceToDeviceSyncConfig = DeviceToDeviceSyncConfig(resourcesToSync)
    Assert.assertTrue(deviceToDeviceSyncConfig.equals(sameDeviceToDeviceSyncConfig))
  }
}
