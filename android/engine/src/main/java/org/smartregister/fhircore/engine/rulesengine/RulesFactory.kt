...
constructor(
  ...
  inner class RulesEngineService {
    ...
    /**
     * This function generates a unique 6-digit integer between 100000 and 999999 Note! Same integer
     * (i.e duplicates) can be generated by two different devices running the app
     */
