...
class CustomParserState<T> {

    private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(CustomParserState.class);
    ...
    boolean isToplevelResourceElement() {
        return myState instanceof CustomParserState.ResourceStateHl7Org || myState instanceof CustomParserState.ResourceStateHapi;
    }
    ...
    private void push(CustomParserState.BaseState theState) {
    ...
    public ICompositeType newCompositeInstance(
            CustomParserState.BasePreResourceState thePreResourceState,
    ...
    public ICompositeType newCompositeTypeInstance(
            CustomParserState.BasePreResourceState thePreResourceState, BaseRuntimeElementCompositeDefinition<?> theCompositeTarget) {
    ...
    private abstract class BaseState {
        ...
        private CustomParserState.BasePreResourceState myPreResourceState;
        private CustomParserState.BaseState myStack;

        BaseState(CustomParserState.BasePreResourceState thePreResourceState) {
            super();
        ...
        public void enteringNewElementExtension(
            ...
            if (myPreResourceState != null && getCurrentElement() instanceof ISupportsUndeclaredExtensions) {
                ...
                CustomParserState.ExtensionState newState = new CustomParserState.ExtensionState(myPreResourceState, newExtension);
                push(newState);
            } else {
                if (theIsModifier == false) {
                    if (getCurrentElement() instanceof IBaseHasExtensions) {
                        ...
                        CustomParserState<T>.ExtensionState newState = new CustomParserState.ExtensionState(myPreResourceState, ext);
                        push(newState);
                    } else {
        ...
        CustomParserState.BasePreResourceState getPreResourceState() {
        ...
        void logAndSwallowUnexpectedElement(String theLocalPart) {
            myErrorHandler.unknownElement(null, theLocalPart);
            push(new CustomParserState.SwallowChildrenWholeState(getPreResourceState()));
        }

        public void setStack(CustomParserState.BaseState theState) {
            myStack = theState;
        }
    ...
    private class ContainedResourcesStateHapi extends CustomParserState.BasePreResourceState {

        public ContainedResourcesStateHapi(CustomParserState.BasePreResourceState thePreResourcesState) {
    ...
    private class ContainedResourcesStateHl7Org extends CustomParserState.BasePreResourceState {

        public ContainedResourcesStateHl7Org(CustomParserState.BasePreResourceState thePreResourcesState) {
    ...
    private class DeclaredExtensionState extends CustomParserState.BaseState {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart) throws DataFormatException {
            ...
            switch (target.getChildType()) {
                case COMPOSITE_DATATYPE: {
                    ...
                    CustomParserState.ElementCompositeState newState = new CustomParserState.ElementCompositeState(
                ...
                case PRIMITIVE_DATATYPE: {
                    ...
                    myDefinition.getMutator().addValue(myParentInstance, newChildInstance);
                    CustomParserState.PrimitiveState newState = new CustomParserState.PrimitiveState(
        ...
        public void enteringNewElementExtension(
            ...
            if (declaredExtension != null) {
                ...
                CustomParserState.BaseState newState =
                        new CustomParserState.DeclaredExtensionState(getPreResourceState(), declaredExtension, myChildInstance);
                push(newState);
            } else {
    ...
    private class ElementCompositeState extends CustomParserState.BaseState {
            ...
            if ("id".equals(theName)) {
                ...
                if (myJsonMode) {
                    myErrorHandler.incorrectJsonType(
                            null, myElementName, BaseJsonLikeValue.ValueType.OBJECT, null, BaseJsonLikeValue.ValueType.SCALAR, BaseJsonLikeValue.ScalarType.STRING);
                } else {
                    myErrorHandler.unknownAttribute(null, theName);
                }
            }
        ...
        public void enteringNewElement(String theNamespace, String theChildName) throws DataFormatException {
            ...
            if (child == null) {
                if (theChildName.equals("id")) {
                    if (getCurrentElement() instanceof IIdentifiableElement) {
                        push(new CustomParserState.IdentifiableElementIdState(
            ...
            switch (target.getChildType()) {
                case COMPOSITE_DATATYPE: {
                    ...
                    CustomParserState<T>.ElementCompositeState newState = new CustomParserState.ElementCompositeState(
                ...
                case PRIMITIVE_XHTML: {
                    ...
                    CustomParserState.XhtmlState state = new CustomParserState.XhtmlState(getPreResourceState(), newDt, true);
                    push(state);
                    return;
                }
                case PRIMITIVE_XHTML_HL7ORG: {
                    ...
                    child.getMutator().addValue(myInstance, newDt);
                    CustomParserState.XhtmlStateHl7Org state = new CustomParserState.XhtmlStateHl7Org(getPreResourceState(), newDt);
                    push(state);
                    return;
                }
                case CONTAINED_RESOURCES: {
                    ...
                    CustomParserState.ContainedResourcesStateHapi state = new CustomParserState.ContainedResourcesStateHapi(getPreResourceState());
                    push(state);
                    return;
                }
                case CONTAINED_RESOURCE_LIST: {
                    CustomParserState.ContainedResourcesStateHl7Org state = new CustomParserState.ContainedResourcesStateHl7Org(getPreResourceState());
                    push(state);
                    return;
                }
                case RESOURCE: {
                    if (myInstance instanceof IAnyResource
                        ...
                        /*if(theChildName.equalsIgnoreCase("locations")) {
                            //BaseRuntimeElementDefinition resourceTarget = target;
                            //IBase newResourceInstance = newInstance((RuntimeChildDeclaredExtensionDefinition) getPreResourceState().getCurrentElement());

                            RuntimeResourceDefinition definition;
                            definition = myContext.getResourceDefinition("Location");
                            child.getMutator().addValue(myInstance, definition.newInstance());
                        }*/
                        CustomParserState<T>.PreResourceStateHl7Org state =
                                new CustomParserState.PreResourceStateHl7Org(myInstance, child.getMutator(), null);
                        push(state);
                    } else {
                        CustomParserState<T>.PreResourceStateHapi state =
                                new CustomParserState.PreResourceStateHapi(myInstance, child.getMutator(), null);
                        push(state);
                    }
                    return;
                }
        ...
        public void enteringNewElementExtension(
            ...
            if (declaredExtension != null) {
                CustomParserState.BaseState newState = new CustomParserState.DeclaredExtensionState(getPreResourceState(), declaredExtension, myInstance);
                push(newState);
            } else {
                super.enteringNewElementExtension(theElement, theUrlAttr, theIsModifier, baseServerUrl);
            }
    ...
    public class ElementIdState extends CustomParserState.BaseState {

        private final IBaseElement myElement;

        ElementIdState(CustomParserState.BasePreResourceState thePreResourceState, IBaseElement theElement) {
            super(thePreResourceState);
    ...
    private class ExtensionState extends CustomParserState.BaseState {

        private final IBaseExtension<?, ?> myExtension;

        ExtensionState(CustomParserState.BasePreResourceState thePreResourceState, IBaseExtension<?, ?> theExtension) {
            super(thePreResourceState);
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart) throws DataFormatException {
            if (theLocalPart.equals("id")) {
                if (getCurrentElement() instanceof IBaseElement) {
                    push(new CustomParserState.ElementIdState(getPreResourceState(), (IBaseElement) getCurrentElement()));
                    return;
                } else if (getCurrentElement() instanceof IIdentifiableElement) {
                    push(new CustomParserState.IdentifiableElementIdState(
                            getPreResourceState(), (IIdentifiableElement) getCurrentElement()));
    ...
    public class IdentifiableElementIdState extends CustomParserState.BaseState {

        private final IIdentifiableElement myElement;

        public IdentifiableElementIdState(CustomParserState.BasePreResourceState thePreResourceState, IIdentifiableElement theElement) {
            super(thePreResourceState);
            myElement = theElement;
        }
    ...
    private class MetaElementState extends CustomParserState.BaseState {
        private final ResourceMetadataMap myMap;

        public MetaElementState(CustomParserState.BasePreResourceState thePreResourceState, ResourceMetadataMap theMap) {
            super(thePreResourceState);
            myMap = theMap;
        }
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart) throws DataFormatException {
            switch (theLocalPart) {
                case "versionId":
                    push(new CustomParserState.MetaVersionElementState(getPreResourceState(), myMap));
                    // } else if (theLocalPart.equals("profile")) {
                    //
                    break;
                case "lastUpdated":
                    InstantDt updated = new InstantDt();
                    push(new CustomParserState.PrimitiveState(getPreResourceState(), updated, theLocalPart, "instant"));
                ...
                case "security":
                    ...
                    push(new CustomParserState.SecurityLabelElementStateHapi(getPreResourceState(), codinfDef, securityLabel));
                ...
                case "profile":
                    ...
                    push(new CustomParserState.PrimitiveState(getPreResourceState(), profile, theLocalPart, "id"));
                ...
                case "tag":
                    ...
                    push(new CustomParserState.TagState(tagList));
                    break;
                default:
                    myErrorHandler.unknownElement(null, theLocalPart);
                    push(new CustomParserState.SwallowChildrenWholeState(getPreResourceState()));
        ...
        public void enteringNewElementExtension(
            ...
            CustomParserState.ExtensionState newState = new CustomParserState.ExtensionState(getPreResourceState(), newExtension);
            push(newState);
        }
    }

    private class MetaVersionElementState extends CustomParserState.BaseState {

        private final ResourceMetadataMap myMap;

        MetaVersionElementState(CustomParserState.BasePreResourceState thePreResourceState, ResourceMetadataMap theMap) {
            super(thePreResourceState);
            myMap = theMap;
        }
    ...
    private abstract class BasePreResourceState extends CustomParserState.BaseState {
        ...
        BasePreResourceState(CustomParserState.BasePreResourceState thePreResourcesState, FhirVersionEnum theParentVersion) {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart) throws DataFormatException {
            ...
            if (myInstance instanceof IResource) {
                push(new CustomParserState.ResourceStateHapi(
                        getRootPreResourceState(), def, (IResource) myInstance, myContainedResources));
            } else {
                push(new CustomParserState.ResourceStateHl7Org(getRootPreResourceState(), def, myInstance));
            }
        }
        ...
        private CustomParserState.BasePreResourceState getRootPreResourceState() {
    ...
    private class PreResourceStateHapi extends CustomParserState.BasePreResourceState {
    ...
    private class PreResourceStateHl7Org extends CustomParserState.BasePreResourceState {
    ...
    private class PreTagListState extends CustomParserState.BaseState {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart) throws DataFormatException {
            ...
            push(new CustomParserState.TagListState(myTagList));
        }
    ...
    private class PrimitiveState extends CustomParserState.BaseState {
        ...
        public void attributeValue(String theName, String theValue) throws DataFormatException {
            ...
            if ("value".equals(theName)) {
                if ("".equals(value)) {
                    CustomParseLocation location = CustomParseLocation.fromElementName(myChildName);
    ...
    private class ResourceStateHapi extends CustomParserState.ElementCompositeState {
        ...
        public void enteringNewElement(String theNamespace, String theChildName) throws DataFormatException {
            if ("id".equals(theChildName)) {
                push(new CustomParserState.PrimitiveState(getPreResourceState(), myInstance.getId(), theChildName, "id"));
            } else if ("meta".equals(theChildName)) {
                push(new CustomParserState.MetaElementState(getPreResourceState(), myInstance.getResourceMetadata()));
            } else {
    ...
    private class ResourceStateHl7Org extends CustomParserState.ElementCompositeState {
    ...
    private class SecurityLabelElementStateHapi extends CustomParserState.ElementCompositeState {
    ...
    private class SwallowChildrenWholeState extends CustomParserState.BaseState {

        private int myDepth;

        SwallowChildrenWholeState(CustomParserState.BasePreResourceState thePreResourceState) {
            super(thePreResourceState);
        }
    ...
    private class TagListState extends CustomParserState.BaseState {
        ...
        public void enteringNewElement(String theNamespaceUri, String theLocalPart) throws DataFormatException {
            if (TagList.ATTR_CATEGORY.equals(theLocalPart)) {
                push(new CustomParserState.TagState(myTagList));
            } else {
    ...
    private class TagState extends CustomParserState.BaseState {
    ...
    private class XhtmlState extends CustomParserState.BaseState {
        private int myDepth;
        private XhtmlDt myDt;
        private List<XMLEvent> myEvents = new ArrayList<XMLEvent>();
        private boolean myIncludeOuterEvent;

        private XhtmlState(CustomParserState.BasePreResourceState thePreResourceState, XhtmlDt theXhtmlDt, boolean theIncludeOuterEvent)
    ...
    private class XhtmlStateHl7Org extends CustomParserState.XhtmlState {
        private IBaseXhtml myHl7OrgDatatype;

        private XhtmlStateHl7Org(CustomParserState.BasePreResourceState thePreResourceState, IBaseXhtml theHl7OrgDatatype) {
     ...
     */
    static <T extends IBaseResource> CustomParserState<T> getPreResourceInstance(
            IParser theParser,
            ...
            throws DataFormatException {
        CustomParserState<T> retVal = new CustomParserState<T>(theParser, theContext, theJsonMode, theErrorHandler);
        if (theResourceType == null) {
    ...
    static CustomParserState<TagList> getPreTagListInstance(
            IParser theParser, FhirContext theContext, boolean theJsonMode, IParserErrorHandler theErrorHandler) {
        CustomParserState<TagList> retVal = new CustomParserState<TagList>(theParser, theContext, theJsonMode, theErrorHandler);
