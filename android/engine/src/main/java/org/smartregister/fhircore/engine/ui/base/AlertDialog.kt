...
fun Activity.showAlert(
  ...
  val dialog =
    AlertDialog.Builder(this)
      .apply {
        val view = this@showAlert.layoutInflater.inflate(R.layout.alert_dialog, null)
        setView(view)
...
fun Activity.showProgressAlert(@StringRes message: Int): AlertDialog {
  return this.showAlert(AlertIntent.PROGRESS, message)
}

fun Activity.showConfirmAlert(
  @StringRes message: Int,
  @StringRes title: Int? = null,
