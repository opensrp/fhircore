...
enum class ServiceMemberIcon(val icon: Int) {
  ...
  @JsonNames("post_partum_mother", "PostPartumMother") POST_PARTUM_MOTHER(R.drawable.ic_post_partum_mother),
  @JsonNames("woman_of_reproductive_age", "WomanOfReproductiveAge") WOMAN_OF_REPRODUCTIVE_AGE(R.drawable.ic_woman_of_reproductive_age),
