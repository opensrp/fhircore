...
fun MeasureReport.StratifierGroupComponent.findRatioRounded(
  denominator: Int,
  ...
  return this.findPopulation(MeasurePopulationType.NUMERATOR)
    ...
    .rounding(roundingStrategy, roundingPrecision)
}
...
fun MeasureReport.StratifierGroupComponent.findPercentageRounded(
  denominator: Int,
  roundingStrategy: RoundingStrategy,
  roundingPrecision: Int,
): String {
