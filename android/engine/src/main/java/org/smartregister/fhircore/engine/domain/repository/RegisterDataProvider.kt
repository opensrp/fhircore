...
interface RegisterDataProvider {
  ...
  suspend fun provideRegisterData(appFeature: AppFeature?): List<RegisterRow>

  suspend fun provideProfileData(appFeature: AppFeature?, patientId: String): PatientProfileData? =
    null
}
