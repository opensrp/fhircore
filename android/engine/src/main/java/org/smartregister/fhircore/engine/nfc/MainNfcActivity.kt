...
class MainNfcActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    binding.protoBtn.setOnClickListener { mainViewModel.generateProtoFile() }

    binding.initBtn.setOnClickListener { mainViewModel.initSAM() }

    // Perform Read action with the UI given by the Service
    binding.readBtn.setOnClickListener { mainViewModel.readSerialized() }
    ...
    DESFireServiceAccess.cardReaderState.observe(this) { binding.textViewCardState.text = it.name }
