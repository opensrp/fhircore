...
constructor(
  ...
  override suspend fun loadRegisterData(
    ...
    withContext(dispatcherProvider.io()) {
      getRegisterDataFilters()!!.let { mainParam ->
        defaultRepository.loadRegisterListData(mainParam, null, null, currentPage).map { mainData ->
          val familyRegisterData =
            parseRegisterMapping(mainParam.name, mainData, configurationRegistry, fhirPathEngine)
          ...
          mainParam.part
            ...
            .map { idParamRef ->
              ...
              (mainData.main.second as Group).member.flatMap {
                defaultRepository.loadRegisterListData(partParam, mainData.main.second, it.entity)
                  .apply {
                    this
                      .map {
                        parseRegisterMapping(
                          partParam.name,
                          it,
  ...
  private suspend fun loadFamilyMemberProfileData(
    memberId: String
  ): ProfileData.FamilyMemberProfileData? =
    defaultRepository.loadResource<Patient>(memberId)!!.let { patient ->
      ...
      ProfileData.FamilyMemberProfileData(
        ...
        gender = patient.gender.toString(), // TODO
