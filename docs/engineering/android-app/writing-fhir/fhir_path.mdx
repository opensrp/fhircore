...
- In this case if either the age OR the calculated-year is true then the question will be enabled.
- But if we used , "enableBehavior": "and" , then both age AND calculated-year will have to be true for the question to be enabled.
