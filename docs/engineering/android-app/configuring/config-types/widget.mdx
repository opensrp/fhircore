...
for use include the ![BABY_BOY](/img/ic_baby_boy.png), ![BABY_GIRL](/img/ic_baby_girl.png), ![WOMAN_OF_REPRODUCTIVE_AGE](/img/ic_woman_of_reproductive_age.png),
![POST_PARTUM_MOTHER](/img/ic_post_partum_mother.png), ![ELDERLY](/img/ic_elderly.png), and ![SICK_CHILD](/img/ic_sick_child.png).
