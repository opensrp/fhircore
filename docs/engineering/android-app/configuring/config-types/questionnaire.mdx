...
Unique ID configs are used to configure how generated unique ID is extracted from a FHIR resource. Currently the Group Resource
is used to sync generated identifiers. 

Here is as sample configuration for the unique identifier assignment:
