...
Unique ID assignment configs are used to configure how pre-generated unique IDs are extracted from a Group FHIR resource which is used to hold a batch of unique IDs. 
