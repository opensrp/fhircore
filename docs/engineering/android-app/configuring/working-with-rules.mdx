...
...
    ...
    This is a tabular representation of the enums used to fetch each of the practitioner info.

    | Practitioner Info| Enum|
    | ---- | ---- |
    | `PractitionerId` | PRACTITIONER_ID |
    | `PractitionerCareTeam` | CARE_TEAM |
    | `PractitionerOrganization` | ORGANIZATION |
    | `PractitionerLocation` | PRACTITIONER_LOCATION |
