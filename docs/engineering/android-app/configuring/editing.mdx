...
This list is handled with fhircore app fun ```prepareQuestionsForReadingOrEditing``` to restrict the input behaviour on the provided link-ids fields when Questionnaire is rendered  
