...
```sh
git clone git@github.com:ona-health/reference-apps.git
# assuming you have checked out fhircore in the same directory
mkdir -p fhircore/android/quest/src/reference-apps/assets/configs
ln -s `pwd`/reference-apps/app/* fhircore/android/quest/src/reference-apps/assets/configs/reference-apps
```
...
````json
{
  ...
  "id": "4abdea5e-31d8-408c-b739-449fcc527bcb",
  "meta": {
      "versionId": "1",
      "lastUpdated": "2024-05-27T14:42:53.345+00:00"
  }
  "url": "https://fhir.labs.smartregister.org/fhir/ImplementationGuide/eir-chw",
  "version": "1.0.0",
  "name": "eir-chw",
  "title": "EIR CHW Implementation Guide",
  "status": "draft",
  "date": "2024-09-30",
  ...
  "definition": {
    "resource": [
      {
        "reference": {
          "reference": "Composition/d49e56e8-26cf-4aa3-9675-234eb99fda91"
        }
      }
    ]
  }
...
- url: "https://fhir.labs.smartregister.org/fhir/ImplementationGuide/eir-chw"
		...
		- The URL where this Implementation Guide can be accessed. It seems to be hosted at fhir.labs.smartregister.org under the path /fhir/ImplementationGuide/eir-chw.
...
- reference:
		...
		- This points to a Composition resource (Composition/d49e56e8-26cf-4aa3-9675-234eb99fda91), which likely contains additional narrative content, instructions, or descriptions related to the IG. The Composition resource is commonly used for documents or structured narratives.
...
````json
{
  ...
  "id": "d49e56e8-26cf-4aa3-9675-234eb99fda91",
  "meta": {
    "versionId": "22",
...
````
 ...
 Here’s a detailed breakdown of the various fields in the config:
	...
	9.	syncStrategy: ["Location"]

		- This suggests that the synchronization strategy involves syncing data related to locations. It might mean that data for locations, such as patient rosters, are synchronized.
    ...
    "actions": [
      {
        ...
        "questionnaire": {
          "id": "5cb30374-6b3d-46a7-858b-803cb0dcecc5",
...
Core Information
	...
	-	Identifies the application as the CHW EIR.
...
This section contains the individual entries or items in the list, each referencing a health facility location. Each entry is represented by an item with a reference to a location resource.
	...
	-	Example: "reference": `"Location/RegionB"` refers to a health facility with a specific Location resource ID.
...
[Caregiver Profile](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/profiles/caregiver_profile_config.json)
...
[child profile](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/profiles/child_profile_config.json)

[TBC]

#### Child Upcoming Immunization Profile Config
[Child Upcoming Immunization Profile](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/profiles/childupcomingencounters_profile_config.json)

[TBC]

#### Child Past Immunizatiion Profile Config
[Child Past Immunizatiion Profile](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/profiles/childpastencounters_profile_config.json)
...
[Child Adverse Reaction Profile](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/profiles/childadversereactions_profile_config.json)
...
[Caregiver Register ](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/registers/caregiver_register_config.json)
...
[Child Register](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/registers/child_register_config.json)
...
Reference PlanDefinition can  be found [here](https://github.com/ona-health/reference-apps/blob/main/eir-chw/fhir_content/plan_definition/child_immunizations.fhir.json)
...
[Strings config](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/translations/strings_config.properties)

[Strings ES config](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/translations/strings_es_config.properties)

[String FR config](https://github.com/ona-health/reference-apps/blob/main/eir-chw/app_configurations/translations/strings_fr_config.properties)
