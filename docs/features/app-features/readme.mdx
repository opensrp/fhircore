...
If there is a typo in a patients name or address, load the patients into a form, fix the typo and resubmit. Configuration options give you the flexibility to specify what fields can be edited.
