...
OpenSRP supports multiple languages through translatable built in content and user managed translations of form and configuration content as described in this [section](../../engineering/app/configuring/internationalization).
