...
![composition configuration](/img/eir_configs/composition-config.png)
![application config](/img/eir_configs/application-config.png)
![list config](/img/eir_configs/list.png)
...
![strings en config](/img/eir_configs/strings-es.png)
![strings es config](/img/eir_configs/strings-en.png)

### Scheduling & tasking
![immunization plandefinition](/img/eir_configs/immunization-pd.png)
...
![login](/img/eir_screenshots/login.png)
![authentication](/img/eir_screenshots/authentication.png)
![set pin](/img/eir_screenshots/set-pin.png)
![sync](/img/eir_screenshots/syncing.png)
![sycn complete](/img/eir_screenshots/sync-complete.png)



![navigation drawer config](/img/eir_screenshots/navigation-drawer.png)
![user settings](/img/eir_screenshots/user-settings.png)
![insights page](/img/eir_screenshots/insights-page.png)



![pending sync](/img/eir_screenshots/pending-sync.png)
...
![caregiver register view](/img/eir_screenshots/caregiver-register.png)
![permisssioins page](/img/eir_screenshots/permissions.png)
![map view](/img/eir_screenshots/maps.png)
![caregiver register search](/img/eir_screenshots/caregiver-search.png)
![caregiver profile view](/img/eir_screenshots/caregiver-profile.png)
...
![child profile view](/img/eir_screenshots/child-profile.png)
![overflow menu](/img/eir_screenshots/overflow-menu.png)
![upcoming encounters page](/img/eir_screenshots/upcoming-encounters.png)
![past encounters page](/img/eir_screenshots/past-encounters.png)
![adverse reaction](/img/eir_screenshots/record-adverse-reaction.png)
![view adverse reactions](/img/eir_screenshots/adverse-reaction.png)
![immunization record](/img/eir_screenshots/immunization-form.png)
...
![mls support](/img/eir_screenshots/mls-support.png)
![homepage spanish](/img/eir_screenshots/homepage-es.png)
![menu spanish](/img/eir_screenshots/navigation-drawer-es.png)
![form spanish](/img/eir_screenshots/registration-es.png)
