...
> Get the details of a child’s immunizations and record vaccines one-by-one or all at-once
>
> ![immunization record](/img/iz-domain/iz-profile.png)

> View all the clients registered in your health system and see their upcoming immunizations
>
> ![child register](/img/iz-domain/child-register.png)
