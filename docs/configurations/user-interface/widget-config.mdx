...
## IMAGE widget
Displays icons or Images. It inherits from ViewProperties and adds or modifies some other attributes.
```json
{
  "viewType": "IMAGE",
  "tint": "#FFFFFF",
...
padding | Dertimines whether the view should fill its parent's width | | false |
