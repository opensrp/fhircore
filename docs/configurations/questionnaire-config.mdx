...
title| FHIR resource to pull/add or update | yes | |
...
These are used when generating other tasks, CarePlans and related resources.See [Plan Definitions section] (https://fhircore.smartregister.org/writing-fhir/plan-definiton)
               ...
               "eventWorkflows": [
                 {
                   ...
                   "triggerConditions": [
                     {
                       "eventResourceId": "carePlansToBeClosed",
                       "matchAll": false,
                   ...
                   "eventResources": [
                     {
                       "id": "carePlansToBeClosed",
                       "resource": "CarePlan",
                       "searchParameter": "subject",
                       "planDefinitions": [
                         "planDefinition-uuid-used-to-generate-the-resources"
                       ],
                       "attributesToUpdate": [
                         {
                           "key": "status",
...
planDefinitions | A list of planDefinition uuids to be used when searching for resources generated by it | yes |
attributesToUpdate | Resource attributes to update e.g set status to inactive, resolved, cancelled e.t.c |      |
